...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.sevnis.grpcbootdemo.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.sevnis.grpcbootdemo.HelloRequest,
      com.sevnis.grpcbootdemo.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.sevnis.grpcbootdemo.HelloRequest.class,
      responseType = com.sevnis.grpcbootdemo.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sevnis.grpcbootdemo.HelloRequest,
      com.sevnis.grpcbootdemo.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.sevnis.grpcbootdemo.HelloRequest, com.sevnis.grpcbootdemo.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.sevnis.grpcbootdemo.HelloRequest, com.sevnis.grpcbootdemo.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sevnis.grpcbootdemo.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sevnis.grpcbootdemo.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.sevnis.grpcbootdemo.HelloRequest request,
        io.grpc.stub.StreamObserver<com.sevnis.grpcbootdemo.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.sevnis.grpcbootdemo.HelloRequest,
                com.sevnis.grpcbootdemo.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public com.sevnis.grpcbootdemo.HelloResponse hello(com.sevnis.grpcbootdemo.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sevnis.grpcbootdemo.HelloResponse> hello(
        com.sevnis.grpcbootdemo.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.sevnis.grpcbootdemo.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.sevnis.grpcbootdemo.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sevnis.grpcbootdemo.Hello.getDescriptor();
    }
